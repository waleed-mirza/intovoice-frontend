/**
 * Local icon components for the voice route. No lucide-react import.
 * Avoids Next.js barrel optimization race ("Cannot read properties of undefined (reading 'call')").
 * SVG paths from lucide-react (ISC). Use same API: className, size, etc.
 */
  ...
  >(({ className, size = 24, ...props }, ref) =>
    React.createElement(
      ...
      children.map(([tag, attrs], i) =>
        React.createElement(tag, { key: (attrs as { key?: string }).key ?? i, ...attrs })
      )
    )
  );
...
export const Compass = createIcon("Compass", [
  ["path", { d: "m16.24 7.76-1.804 5.411a2 2 0 0 1-1.265 1.265L7.76 16.24l1.804-5.411a2 2 0 0 1 1.265-1.265z", key: "9ktpf1" }],
...
export const Loader2 = forwardRef<
  SVGSVGElement,
  React.SVGProps<SVGSVGElement> & { size?: number }
>(({ className, size = 24, ...props }, ref) =>
  React.createElement(
...
/** Crescent moon icon for Religious category. */
export const Crescent = createIcon("Crescent", [
  [
    "path",
    {
...
export const RefreshCw = createIcon("RefreshCw", [
  ...
  ["path", { d: "M21 3v5h-5", key: "1sg2bd" }],
  ["path", { d: "M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L3 16", key: "3uifl3" }],
...
export const Scissors = createIcon("Scissors", [
  ["circle", { cx: "6", cy: "6", r: "3", key: "1lh9kz" }],
  ["path", { d: "M8.12 8.12 12 12", key: "1alksn" }],
  ["path", { d: "M20 4 8.12 15.88", key: "1gk94d" }],
  ["circle", { cx: "6", cy: "18", r: "3", key: "fqmcym" }],
  ["path", { d: "M14.8 14.8 20 20", key: "pt8lj" }],
]);
